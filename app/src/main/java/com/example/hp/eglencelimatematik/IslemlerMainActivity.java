...
public class IslemlerMainActivity extends AppCompatActivity implements  TextToSpeech.OnInitListener {

    protected static final int RESULT_SPEECH = 1;
    private TextToSpeech tts;
    private String name;
    private String msj = "Merhaba.Adın ne?";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_islemler);
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    name = text.get(0);
                    speakOut("Hoşgeldin " + name + " . Hangi işlemi" +
                            " yapmak istersin?");
                    thread1 = new Thread() {
                        @Override
                        public void run() {
