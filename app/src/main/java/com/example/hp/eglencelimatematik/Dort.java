...
public class Dort extends AppCompatActivity implements TextToSpeech.OnInitListener{
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (text.get(0).equals(String.valueOf(4))) {
                        speakOut("Bravo doğru bildin");
                        nextNum();
