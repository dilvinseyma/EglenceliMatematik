...
public class Cikarma extends AppCompatActivity implements MediaPlayer.OnCompletionListener, TextToSpeech.OnInitListener {
...
// Don't forget to shutdown!
    ...
    public void islemleriYap()
    {
        ...
        if (CikarmaSeviye.kolayBasildiMi==true){
        ...
        else if (CikarmaSeviye.ortaBasildiMi==true){
            sayi1 = r.nextInt(41)+10;
            sayi2 = r.nextInt(41)+10;
        ...
        soruText = sayi1text + " eksi "+sayi2text +" işleminin cevabı aşağıdakilerden hangisidir ?";
        //speakOut(soruText);
        ...
        yourthread=  new Thread(){
            ...
            public void run(){
                try {
                    synchronized(this){
                        wait(2500);
                        Intent intent = new Intent(getApplicationContext(), Cikarma.class);
