...
public class Yedi extends AppCompatActivity implements TextToSpeech.OnInitListener{
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (text.get(0).equals(String.valueOf(7))) {
                        speakOut("Tebrikler doğru bildin");
                        nextNum();
