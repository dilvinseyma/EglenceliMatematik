...
public class CikarmaSeviye extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cikarma_seviye);
        ...
        kolayBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                kolayBasildiMi=true;
                ortaBasildiMi=false;
                intent = new Intent(getApplicationContext(),com.example.hp.eglencelimatematik.Cikarma.class);
...
/*
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_cikarma_seviye, menu);
        return true;
    }
